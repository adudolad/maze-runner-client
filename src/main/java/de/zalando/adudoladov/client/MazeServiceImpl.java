 ...
 */
public class MazeServiceImpl extends AbstractMaze implements MazeServiceClient {
    ...
    static {
        ...
        final InputStream readingDefaultContext = MazeServiceImpl.class.getClassLoader().getResourceAsStream(
    ...
    public MazeServiceImpl(final String serverURL) throws IllegalArgumentException {
